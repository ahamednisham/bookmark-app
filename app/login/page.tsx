  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-linear-to-br from-zinc-950 via-zinc-900 to-zinc-950 px-4">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        ...
        <div className="absolute -bottom-40 right-1/4 h-[400px] w-[600px] rounded-full bg-violet-500/8 blur-3xl" />
      </div>
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="rounded-2xl border border-white/10 bg-white/5 p-8 shadow-2xl shadow-black/40 backdrop-blur-xl">
          ...
          <div className="mb-8 text-center">
            <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-2xl bg-linear-to-br from-indigo-500 to-violet-600 shadow-lg shadow-indigo-500/25">
              <svg
          ...
          <button
            ...
            disabled={loading}
            className="group relative flex w-full items-center justify-center gap-3 rounded-xl bg-white px-5 py-3.5 text-sm font-semibold text-zinc-900 shadow-lg shadow-black/10 transition-all duration-200 hover:bg-zinc-100 hover:shadow-xl hover:shadow-black/20 active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-60"
          >
            {/* Google Icon */}
        ...
        {/* Bottom accent */}
        <div className="mx-auto mt-4 h-1 w-24 rounded-full bg-linear-to-r from-indigo-500/50 to-violet-500/50" />
      </div>
    </div>
  );
}
